...
async function processAudioChunk(chunk, transcriptionData, currentChunk, totalChunks) {
    ...
    const myprompt = `נא לתמלל את האודיו המצורף בעברית ברמה הגבוהה ביותר, תוך שימוש במידע הבא: 1. תחום הראיון: חינוך. 2. נושא הראיון: שילוב AI בחינוך. 3. מילות מפתח חשובות: בינה מלאכותית, למידה מותאמת אישית, הכשרת מורים. 4. זיהוי דוברים: הראיון כולל שני דוברים לפחות. יש להשתמש בתוויות "דובר 1" ו"דובר 2" ולשמור על עקביות בהפרדה ביניהם. נא להקפיד לזהות מעבר בין דוברים על פי שינויי קול או תוכן. 5. סגנון הכתיבה: פורמלי, כולל פיסוק מדויק, חותמות זמן ותחביר ברור. חשוב להקפיד על דיוק במונחים מקצועיים, ולכלול את המונחים המצוינים בהקשרם הנכון. כמו כן, במידה והאודיו כולל שמות פרטיים, נסה לתמלל אותם כפי שהם נשמעים.`
